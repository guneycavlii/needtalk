...
import 'package:needtalk/common_widget/platform_duyarli_widget.dart';
  ...
  Future<bool> goster(BuildContext context) async {
    return Platform.isIOS
        ...
        : await showDialog<bool>(
            context: context,
            builder: (context) => this, // this, o an oluşturulan nesneyi döndürür.
            barrierDismissible: false); // Kullanıcı dışarı basarak bunu iptal edemesin.
  }
